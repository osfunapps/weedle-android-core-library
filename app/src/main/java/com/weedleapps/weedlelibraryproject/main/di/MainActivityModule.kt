...
import com.weedleapps.weedlelibraryproject.dagger.scope.PerActivity
...
class MainActivityModule {
    ...
    @Provides
    @PerActivity
    fun provideMainPresenter(mainActivityView: MainActivityView): MainActivityPresenterImpl {
